# Generated by Django 3.2.12 on 2022-03-04 02:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_library', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='users.library')),
                ('careers', models.ManyToManyField(related_name='_users_mentorprofile_careers_+', to='users.Career')),
                ('mentoring_languages', models.ManyToManyField(related_name='_users_mentorprofile_mentoring_languages_+', to='users.Language')),
